...
Object.assign(TEXT_TRANSLATIONS, {
  ...
  "Invoice opened. Add the first line.": "Facture ouverte. Ajoutez la première ligne.",
  "Invoice updated.": "Facture mise à jour.",
  "Invoice deleted.": "Facture supprimée.",
  "Invoice totals": "Totaux de la facture",
  "Invoice summary": "Résumé des factures",
  "Invoice date": "Date de la facture",
  "Owed to you": "Ce qu’on vous doit",
  "across open invoices": "sur les factures ouvertes",
  "on all invoices": "sur toutes les factures",
  "overdue": "en retard",
  "Number, title, customer, phone": "Numéro, titre, client, téléphone",
  "Search invoices": "Rechercher des factures",
  "What you sold and what has been paid, typed by you. Send the PDF over WhatsApp; the balance updates here as payments come in.":
    "Ce que vous avez vendu et ce qui a été payé, saisi par vous. Envoyez le PDF par WhatsApp ; le solde se met à jour ici au fil des paiements.",
  "No invoices yet. Open one the next time you sell something.": "Aucune facture pour l’instant. Ouvrez-en une à votre prochaine vente.",
  "No invoices match this filter.": "Aucune facture ne correspond à ce filtre.",
  "Nothing on this invoice yet. Add the first line.": "Rien sur cette facture pour l’instant. Ajoutez la première ligne.",
  "No payment recorded yet.": "Aucun paiement enregistré pour l’instant.",
  "Save as PDF": "Enregistrer en PDF",
  "Copy as text": "Copier en texte",
  "Record a payment": "Enregistrer un paiement",
  "Pay the whole balance": "Régler tout le solde",
  "Payment recorded — paid in full. This is now a receipt.": "Paiement enregistré — payé en totalité. C’est maintenant un reçu.",
  "Payment reverted.": "Paiement annulé.",
  "Revert payment": "Annuler le paiement",
  "Reverted": "Annulé",
  "PDF handed to the share sheet.": "PDF transmis au menu de partage.",
  "PDF saved to your downloads.": "PDF enregistré dans vos téléchargements.",
  "Copied — paste it into WhatsApp.": "Copié — collez-le dans WhatsApp.",
  "Copy is blocked here. Select the text and copy it yourself.": "La copie est bloquée ici. Sélectionnez le texte et copiez-le vous-même.",
  "Reads inside WhatsApp without opening anything. Send the PDF too for the paper.":
    "Se lit dans WhatsApp sans rien ouvrir. Envoyez aussi le PDF pour le document.",
  "Every change on this invoice, most recent first.": "Chaque modification de cette facture, la plus récente en premier.",
  "Who it is for and when it is due. Lines and payments are edited on the invoice itself.":
    "Pour qui et pour quand. Les lignes et paiements se modifient sur la facture elle-même.",
  "One invoice per deal. Give it a short title and say who it is for; the lines come next.":
    "Une facture par affaire. Donnez-lui un titre court et dites pour qui ; les lignes viennent ensuite.",
  "e.g. 2014 Corolla, or Barrels to Conakry": "ex. Corolla 2014, ou Barils pour Conakry",
  "e.g. 2014 Toyota Corolla, or Barrels to Conakry": "ex. Toyota Corolla 2014, ou Barils pour Conakry",
  "Leave blank if there is no deadline.": "Laissez vide s’il n’y a pas d’échéance.",
  "Notes on the paper": "Notes sur le document",
  "e.g. Sold as is. Title handed over on full payment.": "ex. Vendu en l’état. Titre remis au paiement complet.",
  "Add a line": "Ajouter une ligne",
  "Edit line": "Modifier la ligne",
  "anything you sold: a car, barrels, tyres, a service.": "tout ce que vous avez vendu : une voiture, des barils, des pneus, un service.",
  "Price for one ($)": "Prix unitaire ($)",
  "VIN (cars only)": "VIN (voitures uniquement)",
  "17 characters, printed on the paper": "17 caractères, imprimé sur le document",
  "Line updated.": "Ligne mise à jour.",
  "Qty × each": "Qté × unité",
  "Received": "Reçu le",
  "How": "Comment",
  "Amount received ($)": "Montant reçu ($)",
  "How it arrived": "Comment il est arrivé",
  "still owed.": "encore dû.",
  "Paid in full": "Payé en totalité",
  "No due date": "Pas d’échéance",
  "Copy phone": "Copier le téléphone",
  "Cash App": "Cash App",
  "Cash": "Espèces",
  "Venmo": "Venmo",
  "Zelle": "Zelle",
  "Check": "Chèque",
  "Payment reverted": "Paiement annulé",
  "Line changed": "Ligne modifiée",
  "Opened": "Ouverte",
  "Give the invoice a short title (what it is for).": "Donnez un titre court à la facture (à quoi elle sert).",
  "Say who the invoice is for.": "Dites pour qui est la facture.",
  "The invoice date is not a real date.": "La date de la facture n’est pas une vraie date.",
  "The due date is not a real date.": "La date d’échéance n’est pas une vraie date.",
  "The due date is before the invoice date.": "La date d’échéance précède la date de la facture.",
  "Say what the line is.": "Dites ce qu’est la ligne.",
  "Enter how many (at least one).": "Indiquez combien (au moins un).",
  "Enter the price for one.": "Indiquez le prix unitaire.",
  "That amount is larger than an invoice can carry.": "Ce montant dépasse ce qu’une facture peut porter.",
  "A VIN is 17 letters and digits.": "Un VIN compte 17 lettres et chiffres.",
  "Enter the amount received.": "Indiquez le montant reçu.",
  "Say how the payment arrived.": "Dites comment le paiement est arrivé.",
  "The payment date is not a real date.": "La date du paiement n’est pas une vraie date.",
  "That is more than what is still owed.": "C’est plus que ce qui reste dû.",
  "That invoice no longer exists.": "Cette facture n’existe plus.",
  "That line no longer exists.": "Cette ligne n’existe plus.",
  "That payment no longer exists.": "Ce paiement n’existe plus.",
  "That payment was already reverted.": "Ce paiement a déjà été annulé.",
  "Remove the lines and payments before deleting.": "Retirez les lignes et paiements avant de supprimer.",
  ...
  "Receiver at destination": "Destinataire à l’arrivée",
  "Receiver's phone": "Téléphone du destinataire",
  "The name written on it": "Le nom écrit dessus",
  ...
  "Add & close": "Ajouter et fermer",
  "Added so far:": "Ajouté jusqu’ici :",
  "What it is": "Ce que c’est",
  "How many": "Combien",
