...
export const TEXT_TRANSLATIONS: Record<string, string> = {
  ...
  "Approve this business? Customers will be able to see and use this business after approval.": "Approuver cette entreprise ? Les clients pourront voir et utiliser cette entreprise après approbation.",
  "Approve this hold extension request?": "Approuver cette demande de prolongation de réservation ?",
  "Approve this shared-barrel join request?": "Approuver cette demande de participation au baril partagé ?",
  "Approved": "Approuvé",
  ...
  "Bypass Laawol documents and approve this business? Stripe is complete, and this override will be saved on the verification review.": "Contourner les documents Laawol et approuver cette entreprise ? Stripe est terminé, et cette exception sera enregistrée dans l’examen de vérification.",
  "Business name": "Nom de l’entreprise",
  "Business profile": "Profil de l’entreprise",
  "Buyer": "Acheteur",
  "Cancel": "Annuler",
  "Cancel & refund": "Annuler et rembourser",
  "Cancel this purchase and queue the deposit refund?": "Annuler cet achat et mettre le remboursement de l’acompte en file ?",
  ...
  "Create this platform manager account?": "Créer ce compte gestionnaire de plateforme ?",
  "Create this staff account with the selected permissions?": "Créer ce compte employé avec les autorisations sélectionnées ?",
  ...
  "Escalate this case to the admin team?": "Transférer ce dossier à l’équipe admin ?",
  ...
  "Mark this paid hold as sold?": "Marquer cette réservation payée comme vendue ?",
  "Mark this purchase as completed?": "Marquer cet achat comme terminé ?",
  "Mark this refund request completed?": "Marquer cette demande de remboursement comme terminée ?",
  "Mark this shared barrel balance as collected?": "Marquer ce solde de baril partagé comme encaissé ?",
  ...
  "Reject": "Rejeter",
  "Reject this hold extension request?": "Rejeter cette demande de prolongation de réservation ?",
  "Reject this shared-barrel join request?": "Rejeter cette demande de participation au baril partagé ?",
  "Reopen this support case?": "Rouvrir ce dossier de support ?",
  "Request changes from this business? They will need to respond before approval.": "Demander des modifications à cette entreprise ? Elle devra répondre avant l’approbation.",
  "Request more information on this support case?": "Demander plus d’informations sur ce dossier de support ?",
  "Resolve this support case?": "Résoudre ce dossier de support ?",
  "Remove": "Supprimer",
  "Requests": "Demandes",
  "Review": "Vérifier",
  "Save": "Enregistrer",
  "Save business application rule changes?": "Enregistrer les changements des règles de candidature entreprise ?",
  "Save default barrel pricing and destination changes?": "Enregistrer les changements des tarifs et destinations par défaut des barils ?",
  "Save homepage content changes to the public website?": "Enregistrer les changements de la page d’accueil sur le site public ?",
  "Save internal platform branding changes?": "Enregistrer les changements d’image de marque interne ?",
  "Save platform notification settings? Email and SMS routing may change.": "Enregistrer les paramètres de notification plateforme ? L’acheminement email et SMS peut changer.",
  "Save public website contact changes?": "Enregistrer les changements des contacts publics du site ?",
  "Save role and permission changes? Admin access may change immediately.": "Enregistrer les changements de rôles et d’autorisations ? L’accès admin peut changer immédiatement.",
  "Save these business profile changes? Public details, services, or paid hold pricing may change.": "Enregistrer ces modifications du profil entreprise ? Les informations publiques, les services ou les tarifs de réservation peuvent changer.",
  "Save this shared-barrel capacity adjustment?": "Enregistrer cet ajustement de capacité du baril partagé ?",
  "Save your admin profile changes?": "Enregistrer les changements de votre profil admin ?",
  "Seal this shared barrel pool into a shipment?": "Sceller ce baril partagé en expédition ?",
  "Seal this underfilled pool into a shipment?": "Sceller ce baril incomplet en expédition ?",
  ...
  "Sign in": "Connexion",
  "Sign out? You will need to sign in again to continue.": "Se déconnecter ? Vous devrez vous reconnecter pour continuer.",
  "Log in": "Se connecter",
  ...
  "Shared pools need one active priced destination before you can start one.": "Les barils partagés nécessitent une destination active avec tarif avant de pouvoir commencer.",
  ...
  "Roll this pool into business-held matching?": "Basculer ce baril vers la mise en relation gérée par l’entreprise ?",
  "Uploaded:": "Téléversé :",
  ...
  "Support case needs more information": "Le dossier d’assistance nécessite plus d’informations",
  ...
  "Firebase Trigger Email must be installed with the Firestore collection set to mail and valid SMTP credentials.": "Firebase Trigger Email doit être installé avec la collection Firestore définie sur mail et des identifiants SMTP valides.",
  ...
  "A Firestore SMS worker must process smsMessages records and write delivery status back to each record.": "Un worker SMS Firestore doit traiter les enregistrements smsMessages et écrire le statut de livraison sur chaque enregistrement.",
  ...
  "This confirms your notification provider is connected.": "Cela confirme que votre fournisseur de notifications est connecté.",
  "Connect the Firebase Trigger Email provider before testing.": "Connectez le fournisseur Firebase Trigger Email avant de tester.",
  "Connect the Firestore SMS queue provider before testing.": "Connectez le fournisseur de file SMS Firestore avant de tester.",
  "Choose email or SMS for the notification test": "Choisissez email ou SMS pour le test de notification",
  "Choose email or SMS for the notification test.": "Choisissez email ou SMS pour le test de notification.",
  "Your admin account needs a valid email before testing email.": "Votre compte admin doit avoir un email valide avant de tester l’email.",
  "Your admin account needs a phone number before testing SMS.": "Votre compte admin doit avoir un numéro de téléphone avant de tester le SMS.",
  "The notification test could not be queued.": "Le test de notification n’a pas pu être mis en file.",
